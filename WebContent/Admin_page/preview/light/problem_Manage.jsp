    ...
    <body class="menubar-enabled navbar-top-fixed">
        ...
        <div class="container-fluid mt-15">
            ...
            <div class="card mb-15">
                <div class="card-body">
                    <h4 class="card-title"><b>강좌 문제 관리</b></h4>
                    <div style="color:gray">문제를 만들어 이해를 돕고 성취도를 확인하세요.</div>
                    <div>
                        <button class="btn btn-primary" style="font-size: 13px; ">문제 내려받기</button>
                         <button class="btn btn-primary" style="font-size: 13px;">문제 가져오기</button> 
                         <button class="btn btn-primary" style="font-size: 13px;">새 문제 만들기</button>
                        </div> 
                    <hr>
                    <div class="row">
                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                          <div class="card-body">
                                            <div class="table-responsive">
                                                <h5 style="text-align:center"><b>문제 관리</b></h5>
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center">문제 타입</th>
                                                            <th class="text-center">문제 이름</th>
                                                            <th class="text-center">언어</th>
                                                            <th class="text-center">난이도</th>
                                                            <th class="text-center">작성자</th>
                                                            <th class="text-center">생성시간</th>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="text-center">
                                                                객관식 문제 <span class="badge bg-primary">채점</span>
                                                            </td>
                                                            ...
                                                            <td class="text-center">
                                                                <button class="btn btn-primary" style="font-size:10px;">수정</button>
                                                                <button class="btn btn-primary" style="font-size:10px;">삭제</button>
                                                                <button class="btn btn-primary" style="font-size:10px;">복제</button>
                                                            </td>
                                                        </tr>
