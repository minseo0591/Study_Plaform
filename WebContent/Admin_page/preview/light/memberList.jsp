...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/Study_Platform/Admin_page/css/morioh.css">
    ...
    <body class="menubar-enabled navbar-top-fixed">
        ...
        <div class="container-fluid mt-15">
                                          ...
                                          <div class="card-body">
                                          	<h2 style="text-align: center;">회원목록</h2>
                                                ...
                                                <c:forEach items="${memberlist}" var="list">
                                                    <tr class="text-center">
                                                        <td scope="row">${list.stu_id}</td>
                                                        <td scope="row">${list.stu_pwd}</td>
                                                        <td scope="row">${list.stu_name}</td>
                                                        <td scope="row">
                                                        	<div class="btn-group">
            ...
            <ul class="pagination mt-2" style="justify-content : center;">
		            ...
		            <c:otherwise>
		            <li class="page-item"><a class="page-link" href="./MemberListController.me?page=${startpage-10}">이전</a></li>
		            </c:otherwise>
		            </c:choose>
			         ...
			         <c:forEach var="i" begin="${startpage}" end="${endpage}">
			            ...
			            <li class="page-item"><a class="page-link" href="./MemberListController.me?page=${i}">${i}</a></li>
			            </c:when>
			            </c:choose>
			         </c:forEach>
			         </c:if>
		            ...
		            <c:otherwise>
		            <li class="page-item"><a class="page-link" href="./MemberListController.me?page=${startpage+10}">다음</a></li>
		            </c:otherwise>
		            </c:choose>
