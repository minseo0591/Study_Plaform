        ...
        <div class="container-fluid mt-12">
            ...
            <div class="card mb-15">
                <div class="card-body">
                      ...
                      <button button type="button" class="btn btn-primary float-right" style="margin-top: -10px;" onclick="location.href='/Study_Platform/Admin_page/preview/light/class_add.jsp';">수업 등록</button>
                    <h4 class="card-title"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;요약 정보</b></h4>
                    <hr>
                    <div class="row">
                        <div class="col-12">
                            <div class="food-card">
                                <div class="col-12">
                                    <div class="card">
                                      <div class="row no-gutters">
                                        <div class="col-3">
                                            <h3 class="card-title text-left"><br><b>KJHClass 강좌 가이드</b></h3>
                                          <img src="/Study_Platform/Admin_page/img/math21.png" alt="/Study_Platform/img/imgnull.jpg" class="card-img" style="width: 300px; height: 300px;" />
                                        </div>
                                        <div class="col-9 d-flex flex-wrap justify-content-center">
                                          <div class="card-body">
                                            <table class="table table-bordered" style="margin-top: 40px; overflow-y: hidden;"> <!-- style="margin-top: 80px;" -->
                                                <thead>
                                                ...
                                                <tbody>
                                                    <tr class="text-center">
                                                        <td scope="row">
                                                           BTMCLASS 강좌 개설을<br> 위한 가이드입니다.<br>
                                                           BTMCLASS 강좌 개설을<br> 위한 가이드입니다.<br>
                                                           BTMCLASS 강좌 개설을<br> 위한 가이드입니다.<br>
                                                           BTMCLASS 강좌 개설을<br> 위한 가이드입니다.<br>
                                                        </td>
                                                        <td scope="row">공선환</td>
                                                        <td scope="row">&#x2B50&#x2B50&#x2B50</td>
                                                        <td scope="row">1</td>
                                                      </tr>
                                                </tbody>
                                              </table>
