                        ...
                        <div class="row">
                            <div class="col-lg-3 col-12">
                                ...
                                <div class="card mb-15">
                                    <div class="card-header bg-transparent py-15" style="font-size: 10px;"><b>강의구성</b>
                                        <button class="mdi mdi-hospital btn btn-primary" style="font-size: 10px;"></button>
                                        <button class="mdi mdi-delete-outline btn btn-primary" style="font-size: 10px;"></button>
                                        <button style="font-size: 10px;" class="btn btn-primary">이름 변경</button>
                                        <button style="font-size: 10px;" class="btn btn-primary">위치 변경</button>
                                    </div>
                                    <form>
                                        <button type="button" id="add" class="addBtn mdi mdi-hospital btn btn-primary" style="font-size: 10px;"></button>
                                        버튼을 눌러 챕터를 추가해주세요.
                                    </form>
                                    <div id="itemList">
                                        <ul id = "unlist">챕터1</ul>
                                    ...
                                    <div class="card-body">
                                        <div style="height: 700px; max-width: 100%;" id="hl-line-main"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8 col-12">
                                ...
                                <div class="card mb-15">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-15">
                                            <span class="text-body" style="margin-left: 350px;">강의 내용</span>
                                            <div class="card-body">
                                                <div style="height: 100px; max-width: 100%;" id="hl-line-main"></div>
                                            </div>
                                        </div>
