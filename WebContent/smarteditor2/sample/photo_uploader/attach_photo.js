    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/Study_Platform/lectureJoinController.lc'; 	//upload URL
	 ...
	 */
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/Study_Platform/lectureJoinController.lc',	//샘플 URL입니다.
 	        sCallback : '/Study_Platform/smarteditor2/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
