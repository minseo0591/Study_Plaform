...
public class lectureSearchController implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println("lectureSearchController안의 execute() 실행됨");
		...
		int listSearchCount = lcdao.getListSearchCount(keyWord, searchWord); 
		lcdto = lcdao.ClasslistSearch(page,limit, keyWord, searchWord); 	// 게시물을 LIST 객체에 담습니다. 
		...
		System.out.println("count :" + listSearchCount);
		System.out.println("page :" + page);
